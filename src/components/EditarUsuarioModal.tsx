...
export default function EditarUsuarioModal({
  ...
  const handleSubmit = () => {
    ...
    const payload = {
      id: initialData.id, // importante para identificar qual usuário editar
            ...
            <div style={{ marginBottom: "1rem", display: "flex" }}>
              ...
              <div style={{ width: "80%" }}>
                <input
                  ...
                  readOnly={true} // matrícula não pode ser alterada na edição
                />
